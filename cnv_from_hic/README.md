...
The script will be annotate the Hi-C data using GC content, fragment length and mappability information. According to the data resolution, this part can take some times.
